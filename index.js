...
//
const BotName = ' *putry cantik*'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/kumpulan_foto_anime/'; // Nama Instagramlu cok
const whatsapplu = '+62 822-2549-1446'; // Nomor whatsapplu cok
